...
import { Home, Calendar, Images, User, Menu, X } from 'lucide-react'
  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed top-20 left-4 z-50 bg-blue-600 hover:bg-blue-700 text-white p-3 rounded-xl shadow-lg transition-colors duration-200 flex items-center justify-center"
